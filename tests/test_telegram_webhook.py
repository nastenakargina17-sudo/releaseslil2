...
class TelegramWebhookTests(unittest.TestCase):
    ...
    def test_show_releases_text_button_sends_release_list(self) -> None:
        import app.services.telegram_bot
        ...
        service.handle_message({"chat": {"id": 390144191}, "text": "Показать релизы"})

        service.notifier.send_message.assert_called_once_with(
